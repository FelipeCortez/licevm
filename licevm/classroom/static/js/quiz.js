$("quiz").each(function() {
    ...
    thisQuiz = $(this);
    thisQuiz.text("");
    $('<div class="question">' + question + '</div>').appendTo(thisQuiz);
    options.forEach(function(option) {
        $('<div class="radio"><label><input type="radio" name="r1" id="1" value="' + option.letter + '">' + option.text + '</label></div>').appendTo(thisQuiz);
    });

    $('<div class="feedback"></div>').appendTo(thisQuiz);
